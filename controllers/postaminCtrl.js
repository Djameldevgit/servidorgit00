 const Posts = require('../models/postadminModel')
...
const postadminCtrl = {
    ...
    getUserPostsadmin: async (req, res) => {
        try {
    ...
    getSavePostsadmin: async (req, res) => {
        try {
            const features = new APIfeatures(Posts.find({
